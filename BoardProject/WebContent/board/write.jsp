...
<html>
	...
	<body>
		...
		<!-- 게시판 글쓰기  시작  -->
		<form class="form-horizontal" method="post" enctype = "multipart/form-data"action="write.uijin">
		  <fieldset>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-lg-10">
		        <input type="text" class="form-control" name="title" id="subject" placeholder="제목을 입력하세요.">
		      </div>
		    </div>
